...
export async function obtenerHistorialTanque(materiaId: string) {
  ...
  if (!materiaId) {
    console.error("obtenerHistorialTanque: materiaId está vacío")
    return []
  }

  console.log("obtenerHistorialTanque: buscando para materiaId =", materiaId)
  ...
  console.log("obtenerHistorialTanque: encontrados", data?.length || 0, "registros")
